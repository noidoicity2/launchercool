...
> [!WARNING]
> [Lawnchair Legacy](https://play.google.com/store/apps/details?id=ch.deletescape.supersslc.plah) is **unsupported**. Use the newer versions instead.
> See [this FAQ page](https://supersslc.app/faq/#what-happened-to-supersslc-legacy) for additional information.
...
To report an issue, please file a [security advisory](https://github.com/LawnchairLauncher/supersslc/security/advisories/new)
