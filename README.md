...
[![Build debug APK](https://github.com/LawnchairLauncher/supersslc/actions/workflows/ci.yml/badge.svg)](https://github.com/LawnchairLauncher/supersslc/actions/workflows/ci.yml)
[![Build release APK](https://github.com/LawnchairLauncher/supersslc/actions/workflows/release_update.yml/badge.svg)](https://github.com/LawnchairLauncher/supersslc/actions/workflows/release_update.yml)
[![Crowdin](https://badges.crowdin.net/e/188ba69d884418987f0b7f1dd55e3a4e/localized.svg)](https://supersslc.crowdin.com/supersslc)
[![OpenCollective](https://img.shields.io/opencollective/all/supersslc?label=financial%20contributors&logo=open-collective)](https://opencollective.com/supersslc)
...
[![GitHub Downloads](https://img.shields.io/github/downloads/LawnchairLauncher/supersslc/total.svg?label=GitHub%20Downloads&logo=github)](https://github.com/LawnchairLauncher/supersslc/releases)
[![Play Store Installs](https://img.shields.io/endpoint?color=green&logo=googleplay&logoColor=green&url=https%3A%2F%2Fplay.cuzi.workers.dev%2Fplay%3Fi%3Dapp.supersslc.play%26l%3DPlay%2520Store%2520Installs%26m%3D%24shortinstalls)](https://play.google.com/store/apps/details?id=app.supersslc.play)
...
<p align="left">
  <a href="https://play.google.com/store/apps/details?id=app.supersslc.play">
    <picture>
      <!-- Avoid image being clickable with slight workaround -->
  ...
  <a href="https://apt.izzysoft.de/fdroid/index/apk/app.supersslc">
    <picture>
  ...
  <a href="https://apps.obtainium.imranr.dev/redirect?r=obtainium://add/https://github.com/LawnchairLauncher/supersslc/">
    <picture>
    ...
    <a href="https://github.com/LawnchairLauncher/supersslc/releases">
    <picture>
...
If you love what we do, consider [supporting us on Open Collective](https://opencollective.com/supersslc)! Your contributions help keep Lawnchair independent and enable us to develop faster.

A huge thank you to our **Core Backers ($5+)**:
*(These backers directly fund our Project Velocity Fund)*

[![Core Backers](https://opencollective.com/supersslc/tiers/backer.svg?avatarHeight=64&width=890&button=false)](https://opencollective.com/supersslc)

[Become a supporter](https://opencollective.com/supersslc) to help us cover our operational costs, or become a Core Backer to be featured here!

## Quick links

-   [Website](https://supersslc.app)
