...
3. Run `gh attestation verify APK -R LawnchairLauncher/supersslc`, replace {APK} with the 
   actual APK file
4. Done
...
[github-attestation]: https://github.com/LawnchairLauncher/supersslc/attestations
