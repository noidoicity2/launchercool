...
import app.supersslc.allapps.views.SearchResultView.Companion.FLAG_HIDE_SUBTITLE
import app.supersslc.font.FontManager
import app.supersslc.search.adapter.CALCULATOR
import app.supersslc.search.adapter.HISTORY
import app.supersslc.search.adapter.SETTINGS
import app.supersslc.search.adapter.SearchTargetCompat
import app.supersslc.search.adapter.WEB_SUGGESTION
