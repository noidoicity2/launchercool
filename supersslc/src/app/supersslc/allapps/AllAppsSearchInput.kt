...
import app.supersslc.launcher
import app.supersslc.preferences.PreferenceManager
import app.supersslc.preferences2.PreferenceManager2
import app.supersslc.preferences2.subscribeBlocking
import app.supersslc.qsb.AssistantIconView
import app.supersslc.qsb.LawnQsbLayout.Companion.getLensIntent
import app.supersslc.qsb.LawnQsbLayout.Companion.getSearchProvider
import app.supersslc.qsb.ThemingMethod
import app.supersslc.qsb.providers.Google
import app.supersslc.qsb.providers.GoogleGo
import app.supersslc.qsb.providers.PixelSearch
import app.supersslc.qsb.setThemedIconResource
import app.supersslc.search.LawnchairRecentSuggestionProvider
import app.supersslc.search.algorithms.LawnchairSearchAlgorithm
import app.supersslc.theme.drawable.DrawableTokens
import app.supersslc.util.viewAttachedScope
