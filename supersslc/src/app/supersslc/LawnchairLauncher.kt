...
import app.supersslc.LawnchairApp.Companion.showQuickstepWarningIfNecessary
import app.supersslc.compat.LawnchairQuickstepCompat
import app.supersslc.data.AppDatabase
import app.supersslc.data.wallpaper.service.WallpaperService
import app.supersslc.gestures.GestureController
import app.supersslc.gestures.VerticalSwipeTouchController
...
import app.supersslc.root.RootHelperManager
import app.supersslc.root.RootNotAvailableException
import app.supersslc.theme.ThemeProvider
import app.supersslc.ui.popup.LauncherOptionsPopup
import app.supersslc.ui.popup.LawnchairShortcut
import app.supersslc.util.getThemedIconPacksInstalled
import app.supersslc.util.unsafeLazy
import app.supersslc.views.LawnchairFloatingSurfaceView
