...
import app.supersslc.ui.preferences.components.layout.TwoTabPreferenceLayout
import app.supersslc.ui.preferences.navigation.GeneralCustomIconShapeCreator
...
fun iconShapeEntries(context: Context): List<ListPreferenceEntry<IconShape>> {
    ...
    return listOf(
        // Organized as seen in /supersslc/res/values/strings.xml
