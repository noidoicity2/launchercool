package app.supersslc.search.algorithms

import android.content.Context
import app.supersslc.preferences.PreferenceManager
import app.supersslc.preferences2.PreferenceManager2
import app.supersslc.search.adapter.SearchLinksTarget
import app.supersslc.search.adapter.SearchTargetCompat
import app.supersslc.search.adapter.SearchTargetFactory
import app.supersslc.search.algorithms.engine.ActionsSectionBuilder
import app.supersslc.search.algorithms.engine.AppsAndShortcutsSectionBuilder
import app.supersslc.search.algorithms.engine.CalculationSectionBuilder
import app.supersslc.search.algorithms.engine.ContactsSectionBuilder
import app.supersslc.search.algorithms.engine.EmptyStateSectionBuilder
import app.supersslc.search.algorithms.engine.FilesSectionBuilder
import app.supersslc.search.algorithms.engine.HistorySectionBuilder
import app.supersslc.search.algorithms.engine.SearchProvider
import app.supersslc.search.algorithms.engine.SearchResult
import app.supersslc.search.algorithms.engine.SearchSettingsSectionBuilder
import app.supersslc.search.algorithms.engine.SectionBuilder
import app.supersslc.search.algorithms.engine.SettingsSectionBuilder
import app.supersslc.search.algorithms.engine.WebSuggestionsSectionBuilder
import app.supersslc.search.algorithms.engine.provider.CalculatorSearchProvider
import app.supersslc.search.algorithms.engine.provider.ContactsSearchProvider
import app.supersslc.search.algorithms.engine.provider.FileSearchProvider
import app.supersslc.search.algorithms.engine.provider.HistorySearchProvider
import app.supersslc.search.algorithms.engine.provider.SettingsSearchProvider
import app.supersslc.search.algorithms.engine.provider.ShortcutSearchProvider
import app.supersslc.search.algorithms.engine.provider.apps.AppSearchProvider
import app.supersslc.search.algorithms.engine.provider.web.CustomWebSearchProvider
import app.supersslc.search.algorithms.engine.provider.web.WebSuggestionProvider
