...
import app.supersslc.allapps.views.SearchItemBackground
import app.supersslc.allapps.views.SearchResultView.Companion.EXTRA_QUICK_LAUNCH
import app.supersslc.preferences2.PreferenceManager2
import app.supersslc.search.LawnchairSearchAdapterProvider
import app.supersslc.search.adapter.START_PAGE
import app.supersslc.search.adapter.SearchAdapterItem
import app.supersslc.search.adapter.SearchTargetCompat
import app.supersslc.search.adapter.SearchTargetCompat.Companion.RESULT_TYPE_APPLICATION
import app.supersslc.search.adapter.SearchTargetCompat.Companion.RESULT_TYPE_SHORTCUT
