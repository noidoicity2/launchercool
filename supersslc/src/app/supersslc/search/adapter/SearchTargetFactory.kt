package app.supersslc.search.adapter
...
import app.supersslc.allapps.views.SearchResultView
import app.supersslc.search.algorithms.data.Calculation
import app.supersslc.search.algorithms.data.ContactInfo
import app.supersslc.search.algorithms.data.FileInfo
import app.supersslc.search.algorithms.data.FileInfo.Companion.isImageType
import app.supersslc.search.algorithms.data.FolderInfo
import app.supersslc.search.algorithms.data.IFileInfo
import app.supersslc.search.algorithms.data.RecentKeyword
import app.supersslc.search.algorithms.data.SettingInfo
import app.supersslc.search.algorithms.engine.provider.web.WebSearchProvider
import app.supersslc.theme.color.tokens.ColorTokens
import app.supersslc.util.createTextBitmap
import app.supersslc.util.file2Uri
import app.supersslc.util.mimeCompat
